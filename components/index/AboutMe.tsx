        ...
        <Box h={{base: 'fit-content'}} bg={bg} rounded={20}>
            <VStack ml={{base: 4, md: 8}} mr={{base: 4, md: 8}}>
                ...
                >
                    ...
                    <Text>
                        I'm Rene Presedo and this is my personal webpage, make yourself at
                        home 😁! I'm a software developer who has been working in different
                        fields for the last 6 years. Before getting down to business, here
                    ...
                    <Text mb={{base: 4}} ml={{base: 8}}>
                        ...
                        time consuming task in my life,{' '}
                        <b>
                            <i>Praise the sun!</i>
                        </b>
                    </Text>
                    ...
                    <Text mb={{base: 4}}>
                        ...
                        realized that what I was addicted to was to coding. As in the degree
                        all the coding subjects we had were involved with electronics, I
                        decided to study a master related to that.
                    </Text>
                    <Text>
                        Once I finished my master's thesis, I felt that I needed some real
                        world working experience and found an opportunity as an embedded
                        software developer. Six years have passed since that day, and two
                        things that I can promise are that I learnt a lot and that I enjoyed
                        it a lot!
                    </Text>
                </Flex>
            </VStack>
